...
//   const [userDetails, setUserDetails] = useState<any>(null);
//   const [isLoadingUser, setIsLoadingUser] = useState(false);
//   const [hasFetched, setHasFetched] = useState(false); // ✅ prevents re-fetching unnecessarily
...
//   // Fetch only once when user logs in
//   useEffect(() => {
//     if (user && !hasFetched) {
//       refreshUserDetails();
//     }
...
//         setWard,
//         userDetails,
//         refreshUserDetails, // you can still manually refresh if needed
//         isLoadingUser,
//       }}
//     >
//       {children}
